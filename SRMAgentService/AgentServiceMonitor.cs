...
{
    public partial class AgentServiceMonitor : ServiceBase
    {
        private static readonly ILog Log = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public AgentServiceMonitor()
        {
            Log.Info("AgentServiceMonitor() Start");

            this.ServiceName = "SRMAgentService_Monitor";
            ...
            Log.Info("AgentServiceMonitor() End");
        }
